...
public class GeneralConfig {
	...
	public static boolean enableHardcoreTaint = true;
	...
	public static void loadFromConfig(Configuration config){
		...
		enableSpecialMeteors = config.get(CATEGORY_GENERAL, "1.13_enableSpecialMeteors", true).getBoolean(true);
		...
		enableHardcoreTaint = config.get(CATEGORY_GENERAL, "1.19_enableHardcoreTaint", true).getBoolean(true);
