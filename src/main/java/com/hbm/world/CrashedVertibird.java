...
public class CrashedVertibird extends WorldGenerator
{
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z, boolean force)
	{
		...
		world.setBlockState(pos.setPos(x + 4, y + 7 - yOffset, z + 9), ModBlocks.block_corium.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y + 7 - yOffset, z + 9), ModBlocks.red_wire_coated.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y + 7 - yOffset, z + 9), ModBlocks.block_corium.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 4, y + 8 - yOffset, z + 9), ModBlocks.block_corium.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y + 8 - yOffset, z + 9), ModBlocks.red_wire_coated.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y + 8 - yOffset, z + 9), ModBlocks.block_corium.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y + 8 - yOffset, z + 9), Block1.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 8 - yOffset, z + 10), ModBlocks.block_corium.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y + 8 - yOffset, z + 10), ModBlocks.red_wire_coated.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y + 8 - yOffset, z + 10), ModBlocks.block_corium.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 4, y + 9 - yOffset, z + 10), ModBlocks.block_corium.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y + 9 - yOffset, z + 10), ModBlocks.red_wire_coated.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y + 9 - yOffset, z + 10), ModBlocks.block_corium.getDefaultState(), 3);
