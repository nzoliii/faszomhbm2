...
public class fhbm2GenerateHorrorTower implements IWorldGenerator {

    private static final int STRUCTURE_SIZE = 16;
    private static final String STRUCTURE_NAME = "horror_tower";
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, net.minecraft.world.gen.IChunkGenerator chunkGenerator, net.minecraft.world.chunk.IChunkProvider chunkProvider) {
        ...
        int x = chunkX * 16 + random.nextInt(16) + 100;
        int z = chunkZ * 16 + random.nextInt(16) + 100;
